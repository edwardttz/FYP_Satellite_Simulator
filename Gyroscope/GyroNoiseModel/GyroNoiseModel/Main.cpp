/*This project uses the SpacecraftDynamics class to calculate the ideal angular velocity values, and then calculates the real/noisy angular velocity values using the
...
int main(void) 
{
	...
	//Parameters for the rate noise density
	g1.setDataGenTime(2); 
